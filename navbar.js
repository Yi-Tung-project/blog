...
//	content += '<a class="navbar-brand" href="#">測試網站</a>';
    ...
    content += '<a id="HomeItem" class="nav-link" href="#" onClick=jumpTo("Home.html")>首頁 <span class="sr-only">(current)</span></a>';
    content += '</li>';
    content += '<li class="nav-item dropdown">';
    content += '<a class="nav-link dropdown-toggle" href="#" id="YummyItem" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">口袋美食</a>';
    content += '<div class="dropdown-menu" aria-labelledby="YummyItem">';
